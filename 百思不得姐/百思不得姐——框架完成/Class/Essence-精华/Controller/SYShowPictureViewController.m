...
- (void)viewDidLoad {
    ...
    CGFloat pictureH = pictureW * self.textItem.image.height / self.textItem.image.width;
    ...
    //下载图片
    [imageView sd_setImageWithURL:[NSURL URLWithString:self.textItem.image.download_url.firstObject] placeholderImage:nil options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize) {
