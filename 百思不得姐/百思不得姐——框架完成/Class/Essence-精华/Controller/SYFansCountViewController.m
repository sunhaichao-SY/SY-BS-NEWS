...
@interface SYFansCountViewController ()
@property (nonatomic,strong) NSArray *FansCounts;
@end

@implementation SYFansCountViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass([SYFansCountViewCell class]) bundle:nil] forCellReuseIdentifier:ID];
...
- (void)reloadData{
    ...
    [manager GET: SYFansCountURL parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        //        [responseObject writeToFile:@"/Users/sunhaichao/Desktop/sy.plist" atomically:YES];
        self.FansCounts = [SYFansCountItem mj_objectArrayWithKeyValuesArray:responseObject[@"list"]];
...
{
    SYFansCountViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
